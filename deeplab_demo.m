...
%
%   `cropSize`:: 513
%    The size (in pixels) to which the longer image length will be 
%    resized while preserving aspect ratio (the shorter edge will be padded).
%
...
% Licensed under The MIT License [see LICENSE.md for details]
  ...
  modelName = 'deeplab-vggvd-v2.mat' ;
